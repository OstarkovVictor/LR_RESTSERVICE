package com.example.test_rest_lr.controller;

import com. example.test_rest_lr.entity.Student;
import com. example.test_rest_lr.service.StudentService;
...
public class MyController {
    ...
    @GetMapping("/students")
        public List<Student> showAllStudents(){ List<Student> allStudents = studentService.getAllStudents();
return allStudents;}
